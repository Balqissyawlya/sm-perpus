...
$unduh=$mysqli->query("SELECT * FROM deskripsi_buku WHERE kode_buku='$_GET[id]'");
...
- Judul Buku : <?php $buku=$mysqli->query("SELECT * FROM buku 
...
$no=1;
$tanggal=date('D d-M-Y');
$cetak=$mysqli->query("SELECT * FROM deskripsi_buku WHERE kode_buku='$_GET[id]'");?>
