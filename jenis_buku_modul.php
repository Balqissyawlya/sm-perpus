...
if (empty($_GET['aksi'])) {
    $no = 1;
    $lihat = $mysqli->query("SELECT * FROM jenis_buku Order By kode_jenis");
            ...
            <?php while ($l = $lihat->fetch_array()) { ?>    
                <tr class="data">
                    ...
                    <td class="data" align="center">
                        ...
                        <a href="?halaman=jenis_buku&opsi=ubah&id=<?php echo $l['kode_jenis']; ?>">Ubah</a> | 
                        <img src="ikon/hapus.png" width="20" height="20" align="absmiddle" /> 
                        <a href="?halaman=jenis_buku&skrip=hapus&id=<?php echo $l['kode_jenis']; ?>" onClick="return hapus();">Hapus</a>
                    </td>
                </tr>
                <?php $no++; } ?>
        </table>
        ...
        <tr>
            ...
            <td align="center" class="data">
                <a href="?halaman=jenis_buku&opsi=tambah">
                    <img src="ikon/tambah.png" width="20" height="20" align="absmiddle" /> Tambah
                </a> | 
                <a href="?halaman=jenis_buku&opsi=ekspor">
                    <img src="ikon/ekspor.png" width="20" height="20" align="absmiddle" /> Ekspor
                </a>
            </td>
        </tr>
    </table>
...
if (isset($_GET['opsi']) && $_GET['opsi'] == 'ubah') {
    $ubah = $mysqli->query("SELECT * FROM jenis_buku WHERE kode_jenis='$_GET[id]'");
