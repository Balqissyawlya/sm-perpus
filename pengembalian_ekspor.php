...
$unduh=$mysqli->query("SELECT * FROM pengembalian, buku, anggota 
...
?>
 <table border="0" align="center" bgcolor="#FF9933">
  ...
  <tr bgcolor="#99CC33">
   ...
   <td align="center"><?php echo"$u[judul]"; ?></td> <!-- Mengubah $u['nama_buku'] menjadi $u['judul'] -->
...
$no=1;
$tanggal=date('D d-M-Y');
$cetak=$mysqli->query("SELECT * FROM pengembalian, buku, anggota 
                       WHERE pengembalian.kode_buku=buku.kode_buku 
                       AND pengembalian.kode_anggota=anggota.kode_anggota");?>
