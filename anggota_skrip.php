...
$mysqli->query("INSERT INTO anggota(nama_anggota,alamat,telepon,tgl_masuk,keterangan) 
...
if ($_GET['skrip']=='ubah') {
$mysqli->query("UPDATE anggota SET nama_anggota='$_POST[nama_anggota]',alamat='$_POST[alamat]',telepon='$_POST[telepon]',tgl_masuk='$_POST[tgl_masuk]',keterangan='$_POST[keterangan]' 
			 WHERE kode_anggota='$_POST[id]'");
echo"<div class=ubah>Perubahan Telah Disimpan!</div>";
}
//Skrip untuk aksi hapus
if ($_GET['skrip']=='hapus') {
$mysqli->query("DELETE FROM anggota WHERE kode_anggota='$_GET[id]'");
